    ...
    <div className="sn-collections">
      <div className="sn-collections-card active">
        ...
        <div className="sn-collections-info">
          ...
          <Link href="/shop?filters=true&Gender=Men" className="btn btn-white-outline btn-arrow-long align-center sn-collections-btn">Explore</Link>
        </div>
      </div>
      ...
      <div className="sn-collections-card">
        ...
        <div className="sn-collections-info">
          ...
          <Link href="/shop?filters=true&Gender=Women" className="btn btn-white-outline btn-arrow-long align-center sn-collections-btn">Explore</Link>
        </div>
      </div>
      ...
      <div className="sn-collections-card">
        ...
        <div className="sn-collections-info">
          ...
          <Link href="/shop?filters=true&Gender=Kids" className="btn btn-white-outline btn-arrow-long align-center sn-collections-btn">Explore</Link>
        </div>
      </div>
      ...
      <div className="sn-collections-card">
        ...
        <div className="sn-collections-info">
          ...
          <Link href="/shop?filters=true&Gender=Couple" className="btn btn-white-outline btn-arrow-long align-center sn-collections-btn">Explore</Link>
        </div>
      </div>
    </div>
  </section>
